# cum_other_age_strata.R

plot_cum_other_by_age <- function(
    results_df,
    title = "Cumulative Non-Cancer Deaths",
    x_lab = "Proportion of Cohort Experiencing Cancer Death vs Non-Cancer Death",
    y_lab = "Mean Cumulative Non-Cancer Deaths)",
  ...
  ggplot2::ggplot(
    results_plot_df,
    ggplot2::aes(x = pct_cancer, y = cum_other)
  ) +
    ggplot2::geom_point(
      ggplot2::aes(
        color = time_t_factor,
